...
sudo -u $MY_USER php artisan key:generate
sudo -u $MY_USER php artisan config:cache
sudo -u $MY_USER php artisan cache:clear
sudo -u $MY_USER php artisan config:clear
sudo -u $MY_USER php artisan route:clear
sudo -u $MY_USER php artisan view:clear
sudo -u $MY_USER php artisan optimize:clear
sudo -u $MY_USER php artisan config:cache
