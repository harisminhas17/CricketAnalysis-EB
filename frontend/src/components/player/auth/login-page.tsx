...
// In your login-page.tsx (or wherever you call loginPlayer)
const handleSubmit = async (e: React.FormEvent) => {
  ...
  try {
    ...
    // Only treat as error if success is false
    if (response.success) {
      toast({
      ...
      // Show error only if success is false
      toast({
        title: "Login Failed",
    ...
    // Only show error if success is not true
    const apiError = error as ApiError;
    if (apiError.message.toLowerCase().includes("login successful")) {
      // Treat as success
      toast({
        title: "Login Successful",
        description: "Welcome back! Redirecting to dashboard...",
            ...
            <Tabs value={loginMethod} onValueChange={(value) => setLoginMethod(value as 'email' | 'phone')}>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor={loginMethod} className="text-base font-normal text-black">
                  ...
                  <Input
                    ...
                    value={loginMethod === 'email' ? formData.email : formData.phone_number}
                ...
                {/* Sport Type Field */}
                <div className="space-y-2">
                  <Label htmlFor="sport_type" className="text-base font-normal text-black">
                    Sport Type
                  </Label>
                  <Select 
