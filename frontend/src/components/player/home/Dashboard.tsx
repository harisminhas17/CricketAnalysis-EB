...
import { 
  Calendar, Users, Video, BarChart3, Trophy, Target, TrendingUp,
  Activity, ChevronDown, Play
} from "lucide-react";
...
export const Dashboard = () => {
  ...
  const recentVideos = [
    { title: "Match Session", thumbnail: "https://images.pexels.com/photos/1661950/pexels-photo-1661950.jpeg", tag: "HIGHLIGHTS" },
    { title: "Training Session", thumbnail: "https://images.pexels.com/photos/1661950/pexels-photo-1661950.jpeg", tag: "PRACTICE" },
    { title: "Behind the scenes", thumbnail: "https://images.pexels.com/photos/1661950/pexels-photo-1661950.jpeg", tag: "BTS" },
  ];

  const matchSessions = [
    { title: "Match Session", location: "Stadium A", image: "https://images.pexels.com/photos/1661950/pexels-photo-1661950.jpeg" },
    { title: "Training Session", location: "Stadium B", image: "https://images.pexels.com/photos/1661950/pexels-photo-1661950.jpeg" },
  ];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="flex items-end justify-between h-full gap-3 relative">
                  ...
                  <div className="absolute -left-8 h-full flex flex-col justify-between text-xs text-gray-500">
                    {[100, 75, 50, 25, 0].map((val, idx) => (
                      <span key={idx} className="transform -translate-y-1">{val}</span>
                    ))}
                  </div>
        ...
        <Card className="border-0 shadow-md">
          ...
          <CardContent className="space-y-4">
            ...
            <Button className="w-full bg-[#344FA5] hover:bg-[#2A3F85] transition-colors duration-200">
              Submit
            </Button>
          </CardContent>
        </Card>
            ...
            {recentVideos.map((video, index) => (
              <div key={index} className="relative group cursor-pointer">
                <div className="aspect-video bg-gray-100 rounded-lg flex items-center justify-center relative overflow-hidden">
                  ...
                  <Badge className="absolute top-2 left-2 bg-[#344FA5] text-white text-xs">
                    {video.tag}
                  </Badge>
                </div>
