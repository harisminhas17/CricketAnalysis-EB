"use client"
import { Hash, Calendar, Video, Plus, Heart, MessageCircle, Share, Camera } from "lucide-react"
...
export const SocialMedia = () => {
  const suggestedPlayers = [
    { name: "Zakary Glen Foulkes", team: "Team Newzealand", avatar: "/placeholder.svg?height=40&width=40&text=ZF" },
    { name: "Jacob Andrew Duffy", team: "Team Newzealand", avatar: "/placeholder.svg?height=40&width=40&text=JD" },
    { name: "Mitchell Josef", team: "Team Newzealand", avatar: "/placeholder.svg?height=40&width=40&text=MJ" },
  ]
  ...
  const posts = [
    {
      ...
      image: "/placeholder.svg?height=300&width=500&text=Cricket+Match+Highlights",
      likes: 11,
      comments: 6,
      shares: 5,
    },
    {
      ...
      image: "/placeholder.svg?height=300&width=500&text=Team+Training+Session",
      likes: 24,
      comments: 12,
      shares: 8,
    },
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                <Avatar className="flex-shrink-0">
                  <AvatarImage src="/placeholder.svg?height=40&width=40&text=KW" />
                ...
                {suggestedPlayers.map((player, index) => (
                  <div key={index} className="flex items-center justify-between gap-3">
                    ...
                    <Button
                      size="sm"
                      variant="outline"
                      className="flex-shrink-0 rounded-full border-[#344FA5] text-[#344FA5] hover:bg-[#344FA5] hover:text-white transition-colors duration-200 bg-transparent"
                    >
                      Follow
                    </Button>
                  </div>
